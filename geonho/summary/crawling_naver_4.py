...
from utils_crawling_4 import *

KEYWORDS = ['코스피', 'KOSPI', '코스닥', 'KOSDAQ'] 
...
def run_crawling(
    ...
    out_news = f"data/NAVER/article/news_{year}_4_{start_date}_top{topk}.csv"
    out_comments = f"data/NAVER/comments/comments_{year}_4_{start_date}_top{topk}.csv"
