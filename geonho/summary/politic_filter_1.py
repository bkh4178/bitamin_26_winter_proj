...
def run_politic_filter(year: int):
    ...
    input_file = f"data/NAVER/comments/comments_{year}_1_top5.csv"
    ...
    political_comments.to_csv(
        f"{output_dir}/comments_{year}_1_political_only.csv",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    non_political_comments.to_csv(
        f"{output_dir}/comments_{year}_1_non_political_only.csv",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    cleaned.to_csv(
        f"{output_dir}/comments_political_removed_{year}_1.csv",
        index=False,
        encoding="utf-8-sig"
    )
