...
def main():
    ...
    ap.add_argument("--out_news", default="data/NAVER/article/news_2023_top5.csv")
    ap.add_argument("--out_comments", default="data/NAVER/comments/comments_2023_top5.csv")
    ...
    # year가 들어오면 start/end 자동 설정
    args.start = f"{year}0101"
    args.end = f"{year}1231"

    # 출력 파일도 자동 변경
    args.out_news = f"data/NAVER/article/news_{year}_top{args.topk}.csv"
    args.out_comments = f"data/NAVER/comments/comments_{year}_top{args.topk}.csv"
