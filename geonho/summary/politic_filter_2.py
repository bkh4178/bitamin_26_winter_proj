...
def run_politic_filter(year: int):
    ...
    input_file = f"data/NAVER/comments/comments_{year}_2_top5.csv"
    ...
    # 전체 분류 저장
    df.to_csv(
        f"{output_dir}/comments_{year}_2_classified.csv",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    political_comments.to_csv(
        f"{output_dir}/comments_{year}_2_political_only.csv",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    non_political_comments.to_csv(
        f"{output_dir}/comments_{year}_2_non_political_only.csv",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    cleaned.to_csv(
        f"{output_dir}/comments_political_removed_{year}_2.csv",
        index=False,
        encoding="utf-8-sig"
    )
